...
module.exports = {
  ...
  async execute(interaction) {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        { name: "User commands", value: "`/talk`, `/mood`, `/feed-ghost`, `/compliment-ghost`, `/ghost-profile`, `/ghost-dm-mode`, `/what-do-you-remember`, `/privacy-settings`, `/what-did-you-tell-alex`, `/sleep-now`, `/wake-up`, `/forget-topic`, `/forget-chat-history`, `/forget-me`, `/list-stickers`, `/ghost-help`" },
        { name: "Privacy/check-ins", value: "`/allow-owner-summary`, `/deny-owner-summary`, `/allow-owner-quotes`, `/deny-owner-quotes`, `/enable-girlfriend-checkins`, `/disable-girlfriend-checkins`, `/routine-settings`, `/enable-routine`, `/disable-routine`" },
        { name: "Admin/owner commands", value: "`/activate-ghost`, `/deactivate-ghost`, `/ghost-status`, `/ghost-settings`, `/owner-report`, `/send-ghost-checkin`, `/set-girlfriend-checkins`, `/set-timezone`, `/set-goodmorning-time`, `/set-bedtime-time`, `/set-gf-note`, `/remove-gf-note`, `/gf-profile`, `/set-ghost-channel`" },
